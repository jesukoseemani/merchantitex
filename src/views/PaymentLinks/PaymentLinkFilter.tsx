...
interface FilterModalProps {
    isOpen: boolean;
    handleClose: () => void;
    action?: (form: typeof PAYMENTLINK_FILTER_DATA) => void;
...
const PaymentLinkFilter = ({
    ...
    const [form, setForm] = useState(PAYMENTLINK_FILTER_DATA);
    ...
    const clear = () => {
        setForm(PAYMENTLINK_FILTER_DATA);
        handleClose?.();
    }
