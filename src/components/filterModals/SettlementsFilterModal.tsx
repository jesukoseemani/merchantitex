...
interface FilterModalProps {
    isOpen: boolean;
    handleClose: () => void;
    action?: (form: typeof SETTLEMENT_FILTER_DATA) => void;
...
const FilterModal = ({
    ...
    const [form, setForm] = useState(SETTLEMENT_FILTER_DATA);
    ...
    const clear = () => {
        setForm(SETTLEMENT_FILTER_DATA);
        handleClose?.();
    }
                ...
                <div className={styles.modalContent}>
                    ...
                    <div>
                        ...
                        >
                            ...
                            <MenuItem value='F9'>Error</MenuItem>
