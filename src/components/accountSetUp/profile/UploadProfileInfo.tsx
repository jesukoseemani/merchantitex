...
const ProfileUploadDocument = ({ handleBack, handleNext }: Props) => {
    ...
    return (
        <Grid container columnSpacing={6} rowGap={2} justifyContent="space-between">


            <Grid item xs={12} sm={6} md={6}>
                <InputLabel className={Styles.label}>Upload utility bill</InputLabel>
            ...
            <Grid item xs={12} sm={6} md={6}>
                ...
                <StyledTextField variant='outlined' fullWidth placeholder="123456789" />
